...
export default function RegisterForm() {
  ...
  // Reset registration state on mount
  useEffect(() => {
  ...
  if (verificationSent && registrationMethod === 'email') {
    return (
  ...
  if (verificationSent && registrationMethod === 'google') {
    return (
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow-xl sm:rounded-xl sm:px-10">
          <div className="text-center">
  ...
  return (
    <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
      <div className="bg-white py-8 px-4 shadow-xl sm:rounded-xl sm:px-10">
        <form onSubmit={handleEmailRegister} className="space-y-6" autoComplete="off">
          <div>
          ...
          <div>
            ...
            <div className="mt-1">
              <input
                ...
                className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm text-black"
              />
            </div>
          </div>

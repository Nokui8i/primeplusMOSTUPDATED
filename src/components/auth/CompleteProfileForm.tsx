    ...
    <form onSubmit={handleSubmit} className="mt-8 space-y-6">
      <div>
        ...
        <div className="mt-1">
          <input
            ...
            className="appearance-none block w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#FF4081] focus:border-transparent transition-all duration-200 text-black"
      ...
      <div>
        ...
        <div className="mt-1 relative">
          <input
            ...
            className={`appearance-none block w-full px-4 py-3 border rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-200 text-black ${
              username.length >= 3
      ...
      <div>
        <button
          type="submit"
          disabled={loading}
          className={`w-full flex justify-center py-3 px-4 border border-transparent rounded-xl shadow-sm text-sm font-medium text-white bg-gradient-to-r from-[#6B3BFF] to-[#2B55FF] hover:from-[#7C5FE6] hover:to-[#3B6BFF] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#6B3BFF] transition-all duration-200 ${
